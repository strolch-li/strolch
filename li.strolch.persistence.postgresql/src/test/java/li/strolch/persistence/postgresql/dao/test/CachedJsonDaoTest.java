...
public class CachedJsonDaoTest extends AbstractModelTest {
	...
	public static void beforeClass() throws Exception {
		...
		dropSchema(CachedJsonDaoTest.class.getSimpleName(), SCRIPT_PREFIX_ARCHIVE, DB_URL, DB_USERNAME, DB_PASSWORD);
		dropSchema(CachedJsonDaoTest.class.getSimpleName(), SCRIPT_PREFIX_STROLCH, DB_URL, DB_USERNAME, DB_PASSWORD);
