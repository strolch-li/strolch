...
public class MathHelper {
	 ...
	 * than the given bound. <p> Note: this implementation tests if the value < bound, and if this is not so, checks if
	...
	public static String toPrecisionString(double value) {
		return toPrecisionString(value, PRECISION_DIGITS);
	}

	public static String toPrecisionString(double value, int decimals) {
		if (value == 0.0)
			return "0.0";
		if (Double.isNaN(value))
			return "" + Double.NaN;
