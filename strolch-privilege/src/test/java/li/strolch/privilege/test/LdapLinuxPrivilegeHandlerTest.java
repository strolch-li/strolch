...
public class LdapLinuxPrivilegeHandlerTest extends AbstractPrivilegeTest {

	@BeforeClass
	public static void init() throws IOException {
		removeConfigs(LdapLinuxPrivilegeHandlerTest.class.getSimpleName());
		prepareConfigs(LdapLinuxPrivilegeHandlerTest.class.getSimpleName(), "PrivilegeConfigLdapLinuxSvcUser.xml",
		...
		Files.copy(new File(SRC_TEST_RESOURCES_CONFIG, "LdapGroupsConfig.json").toPath(),
				new File("target/" + LdapLinuxPrivilegeHandlerTest.class.getSimpleName(),
						"LdapGroupsConfig.json").toPath());
	}

	@Before
	public void setup() {
		initialize(LdapLinuxPrivilegeHandlerTest.class.getSimpleName(), "PrivilegeConfigLdapLinuxSvcUser.xml");
	}
