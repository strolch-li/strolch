 ...
 * <p>
 * An interval represents the time on the time-line between two {@link Instant}s. The class stores the start and end
 * instants, with the start inclusive and the end exclusive. The end instant is always greater than or equal to the
 * start instant.
 * <p>
...
public final class Interval implements Serializable {
	 ...
	 *
	 * @throws DateTimeException   if the end is before the start, or if the duration addition cannot be made
	...
	private static Interval parseEndDateTime(Instant start, ZoneOffset offset, CharSequence endStr) {
		try {
			TemporalAccessor temporal = DateTimeFormatter.ISO_DATE_TIME.parseBest(endStr, OffsetDateTime::from,
					LocalDateTime::from);
	 ...
	 * <p>
	 * This will return {@link Instant#MIN} if the range is unbounded at the start. In this case, the range includes all
	 * dates into the far-past.
	 *
	 ...
	 * <p>
	 * This will return {@link Instant#MAX} if the range is unbounded at the end. In this case, the range includes all
	 * dates into the far-future.
	 *
	 ...
	 * <p>
	 * This checks if the specified instant is within the bounds of this interval. If this range has an unbounded start
	 * then {@code contains(Instant#MIN)} returns true. If this range has an unbounded end then
	 * {@code contains(Instant#MAX)} returns true. If this range is empty then this method always returns false.
	 *
	 ...
	 * <p>
	 * This checks if the bounds of the specified interval are within the bounds of this interval. An empty interval
	 * encloses itself.
	 *
	 ...
	 * <p>
	 * The result is true if the end of this interval is the start of the other, or vice versa. An empty interval does
	 * not abut itself.
	 *
	 * @param other the other interval, not null
	 *
	 ...
	 * <p>
	 * The result is true if the two intervals have an enclosed interval in common, even if that interval is empty. An
	 * empty interval is connected to itself.
	 * <p>
	 ...
	 * <p>
	 * This finds the intersection of two intervals. This throws an exception if the two intervals are not
	 * {@linkplain #isConnected(Interval) connected}.
	 *
	 ...
	 * <p>
	 * This finds the union of two intervals. This throws an exception if the two intervals are not
	 * {@linkplain #isConnected(Interval) connected}.
	 *
	 * @param other the other interval to check for, not null
	 *
	 ...
	 * <p>
	 * The result of this method will {@linkplain #encloses(Interval) enclose} this interval and the specified
	 * interval.
	 *
	 * @param other the other interval to check for, not null
	 *
	 ...
	 * <p>
	 * The result is true if this instant starts after the specified instant. An empty interval behaves as though it is
	 * an instant for comparison purposes.
	 *
	 ...
	 * <p>
	 * The result is true if this instant ends before the specified instant. Since intervals do not include their end
	 * points, this will return true if the instant equals the end of the interval. An empty interval behaves as though
	 * it is an instant for comparison purposes.
	 *
	 * @param instant the other instant to compare to, not null
	 *
	 ...
	 * <p>
	 * The result is true if this instant starts after the end of the specified interval. Since intervals do not include
	 * their end points, this will return true if the instant equals the end of the interval. An empty interval behaves
	 * as though it is an instant for comparison purposes.
	 *
	 ...
	 * <p>
	 * The result is true if this instant ends before the start of the specified interval. Since intervals do not
	 * include their end points, this will return true if the two intervals abut. An empty interval behaves as though it
	 * is an instant for comparison purposes.
	 *
	 * @param interval the other interval to compare to, not null
	 *
