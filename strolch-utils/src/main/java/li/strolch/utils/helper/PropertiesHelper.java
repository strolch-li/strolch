...
public class PropertiesHelper {
	 ...
	 *
	 * @param properties the {@link Properties} from which to retrieve the property
	 * @param context    The context should be the name of the caller, so that stack trace gives enough detail as to
	 *                   which class expected the configuration property if no property was found
	 * @param key        the key of the property to return
	 * @param def        the default value, if null, then an exception will be thrown if the property is not set
	 *
	 * @return the property under the given key
	 *
	 * @throws RuntimeException if the property is not set and def is null
	 */
	 ...
	 *
	 * @param context The context should be the name of the caller, so that stack trace gives enough detail as to which
