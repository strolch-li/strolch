/*
 * Copyright (c) 2014-2025 Robert von Burg <eitch@eitchnet.ch>
 *
...
public interface FileProgressListener {
	 ...
	 * @param position the position relative to the job size
	 * @param size     the size of the job which is to be accomplished
	 */
	 ...
	 *
	 * @param percent  the percent completed. Ideally the value would be 100, but in cases of errors it can be less
	 * @param position the position where the job finished. Ideally the value would be the same as the size given at
	 *                 {@link
