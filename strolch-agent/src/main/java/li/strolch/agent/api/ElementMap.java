 ...
 * </p>
 *
 * @param <T> the object instance being managed
 *
...
public interface ElementMap<T extends StrolchRootElement> {
	 ...
	 *
	 * @param tx   the open {@link StrolchTransaction}
	 * @param type the type of element for which the number of elements is to be queried
	 *
	 ...
	 *
	 * @param tx   the open {@link StrolchTransaction}
	 * @param type The template id to return
	 *
	 ...
	 * @param tx           the open {@link StrolchTransaction}
	 * @param type         The template id to return
	 * @param assertExists if true, and element does not exist, then a {@link StrolchException} is thrown
	 *
	 * @return the template, or null if it does not exist
	 *
	 * @throws StrolchException if the template does not exist
	 */
	 ...
	 * @return the element with the type and id, or null if it does not exist
	 *
	 * @throws StrolchException if the element does not exist
	 */
	 ...
	 * @throws StrolchException if the element does not exist
	 */
	T getBy(StrolchTransaction tx, String type, String id, int version, boolean assertExists) throws StrolchException;
	 ...
	 * {@link StrolchModelConstants#INTERPRETATION_ORDER_REF} and the UOM must be set to the element's type and the
	 * value is the id of the element
	 *
	 * @param tx           the {@link StrolchTransaction} instance
	 * @param refP         the {@link StringParameter} which references an element
	 * @param assertExists if true, and element does not exist, then a {@link StrolchException} is thrown
	 *
	 ...
	 *
	 * @param tx           the {@link StrolchTransaction} instance
	 * @param refP         the {@link StringListParameter} which references an element
	 * @param assertExists if true, and element does not exist, then a {@link StrolchException} is thrown
	 *
	 ...
	 *
	 * @param tx   the {@link StrolchTransaction} instance
	 * @param type the type of the element to retrieve the keys for
	 *
	 ...
	 *
	 * @throws StrolchPersistenceException if an element already exists with the same ID
	 */
	 ...
	 *
	 * @throws StrolchPersistenceException if any of the elements don't yet exist
	 */
	 ...
	 *
	 * @param tx      the {@link StrolchTransaction} instance
	 * @param element the element which is to be reverted to a previous version
	 *
	 * @return the version before the given version. If the given version is the first version, null is returned
	 *
	 * @throws StrolchException if the version does not exist, if this version is not the latest version, if the
	 *                          previous version is missing or other problems arise
	 */
	T undoVersion(StrolchTransaction tx, T element) throws StrolchException;
	 ...
	 *
	 * @param tx      the {@link StrolchTransaction} instance
	 * @param element the version of the element to revert to
	 *
	 * @return the new version of the element
	 *
	 * @throws StrolchException if the version does not exist
	 */
	 ...
	 *
	 * @param tx      the {@link StrolchTransaction} instance
	 * @param type    the type of the element to revert to
	 * @param id      the id of the element to revert to
	 * @param version the version of the specified element to revert to
	 *
	 * @return the new version of the element
	 *
	 * @throws StrolchException if the version does not exist
