...
public class OrderModelTestRunner {
	...
	public void runCreateOrderTest() {
		...
		// create
		Order newOrder = createOrder("MyTestOrder", "Test Name", "TestType");
	...
	public void runQuerySizeTest() {
		...
		Order order2 = createOrder("myTestOrder2", "Test Name", "QTestType2");
		Order order3 = createOrder("myTestOrder3", "Test Name", "QTestType3");
