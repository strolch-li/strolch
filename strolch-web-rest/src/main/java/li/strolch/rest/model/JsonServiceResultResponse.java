...
public class JsonServiceResultResponse extends ServiceResultResponse {
	...
	public JsonServiceResultResponse(JsonServiceResult serviceResult, boolean withStackTrace,boolean onlyRootCause) {
		super(serviceResult, withStackTrace,onlyRootCause);
