...
public class StrolchRootElementToJsonVisitor implements StrolchRootElementVisitor<JsonObject> {
	...
	public StrolchRootElementToJsonVisitor withStateVariables() {
		this.visitor.withStateVariables();
		return this;
	}
	...
	public StrolchRootElementToJsonVisitor ignoreBags(String... bagIds) {
		this.visitor.ignoreBags(bagIds);
		return this;
	}

	public StrolchRootElementToJsonVisitor ignoreParameter(String paramId) {
		this.visitor.ignoreParameter(paramId);
		return this;
	}
