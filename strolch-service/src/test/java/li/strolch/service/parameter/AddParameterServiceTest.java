 ...
 */
public class AddParameterServiceTest extends AbstractRealmServiceTest<AddParameterArg, ServiceResult> {
	...
	@Override
	protected Class<? extends Service<AddParameterArg, ServiceResult>> getSvcClass() {
		return AddParameterService.class;
	}

	@Override
	protected AddParameterArg getArgInstance() {
