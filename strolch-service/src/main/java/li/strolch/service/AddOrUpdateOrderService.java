/*
 * Copyright (c) 2017-2024 Robert von Burg <eitch@eitchnet.ch>
 *
 ...
 */
public class AddOrUpdateOrderService extends AbstractService<StrolchRootElementArgument, ServiceResult> {
