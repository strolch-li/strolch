...
public class PropertiesHelper {
	 ...
	 * @param context
	 * 		The context should be the name of the caller, so that stack trace gives enough detail as to which class
	 * 		expected the configuration property if no property was found
	 * @param key
	...
	/**
	 * Delegates to {@link #getProperty(String, String, String)} but returns the value as a {@link Boolean} where {@link
	 * Boolean#valueOf(String)} defines the actual value
	 *
	 * @return the property as a {@link Boolean} under the given key
	 *
	 * @throws RuntimeException
	...
	/**
	 * Delegates to {@link #getProperty(String, String, String)} but returns the value as an {@link Double} where {@link
	 * Double#valueOf(String)} defines the actual value
	 *
	 * @return the property as a {@link Double} under the given key
	 *
	 * @throws RuntimeException
	...
	/**
	 * Delegates to {@link #getProperty(String, String, String)} but returns the value as an {@link Long} where {@link
	 * Long#valueOf(String)} defines the actual value
	 *
	 * @return the property as a {@link Long} under the given key
	 *
	 * @throws RuntimeException
