...
CREATE INDEX IF NOT EXISTS idx_orders_date ON orders (date NULLS LAST);
...
CREATE TABLE IF NOT EXISTS audits (
  ...
  element_accessed varchar NOT NULL,
...
DROP INDEX IF EXISTS idx_operations_log_values_id;
CREATE INDEX idx_operations_log_values_id
    ON operations_log_values (id)
;
