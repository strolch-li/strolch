 ...
 */
public class AddResourceService extends AbstractService<AddResourceArg, ServiceResult> {
	...
	@Override
	public AddResourceArg getArgumentInstance() {
		return new AddResourceArg();
	}
